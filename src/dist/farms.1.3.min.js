...
function validateRequired(e){var a=document.querySelectorAll("input[required]"+e+",textarea[required]"+e),i=!0;return $.each(a,function(e,a){a.value?$(a).siblings(".required-error").hide():($(a).siblings(".required-error").show(),i=!1)}),i}function validateEmail(e){e.preventDefault(),validateRequired(".email")&&grecaptcha.execute(FARMS.emailRecaptcha)}function validateMailingSubscription(e){e.preventDefault(),validateRequired(".mailing")&&grecaptcha.execute(FARMS.recaptchaMailing)}function onSubmitEmail(){onSubmit("#email-form")}function onSubmitMailing(){onSubmit("#mailing-form")}function onSubmit(e){$(e+" .contact-form-button-group").hide(),$(e+" .contact-form-sending").show(),$.ajax({url:"contactsubmit.php",type:"POST",data:$(e).serialize(),dataType:"json",success:function(a){$(e+" .contact-form-success").show(),setTimeout(function(){$(e+" .contact-form-success").fadeOut()},5e3),$(e+" .contact-form-button-group").show(),$(e+" .contact-form-sending").hide(),$(e)[0].reset()},error:function(a){$(e+" .contact-form-failure").show(),setTimeout(function(){$(e+" .contact-form-failure").fadeOut()},5e3),$(e+" .contact-form-button-group").show(),$(e+" .contact-form-sending").hide()}})}function captchaCallback(){FARMS.emailRecaptcha=grecaptcha.render("emailRecaptcha",{sitekey:"6Lc8_TYUAAAAANc47TO81_x4gGwS8IPHQZRRAMg2",callback:"onSubmitEmail",badge:"inline",size:"invisible"}),FARMS.recaptchaMailing=grecaptcha.render("recaptchaMailing",{sitekey:"6Lc8_TYUAAAAANc47TO81_x4gGwS8IPHQZRRAMg2",callback:"onSubmitMailing",badge:"inline",size:"invisible"})}$("#note").on("change keyup paste",function(e){validateRequired('.email[name="note"]')}),$("#email").on("change keyup paste",function(e){validateRequired('.email[name="email"]')}),$("#name").on("change keyup paste",function(e){validateRequired('.mailing[name="name"]')}),$("#mailingaddress").on("change keyup paste",function(e){validateRequired('.mailing[name="mailingaddress"]')}),$("#city").on("change keyup paste",function(e){validateRequired('.mailing[name="city"]')}),$("#state").on("change keyup paste",function(e){validateRequired('.mailing[name="state"]')}),$("#zip").on("change keyup paste",function(e){validateRequired('.mailing[name="zip"]')}),$("#country").on("change keyup paste",function(e){validateRequired('.mailing[name="country"]')});var FARMS={};$("#message-submit").click(function(e){validateEmail(e)}),$("#mc-embedded-subscribe").on("click",function(e){return void 0!=$(".mc-email").val()&&""!=$(".mc-email").val()||($(".mc-email-error").toggle(),!1)}),$("#mail-submit").click(function(e){validateMailingSubscription(e)}),$("#farmsAge").text((new Date).getFullYear()-1961);
!function(){for(var n,e=function(){},i=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeline","timelineEnd","timeStamp","trace","warn"],t=i.length,o=window.console=window.console||{};t--;)n=i[t],o[n]||(o[n]=e)}(),function(n){n.fn.textfill=function(e){return e=parseInt(e,10),this.each(function(){var i=n("span",this),t=i.parent(),o=(t.height(),t.width()),r=parseInt(i.css("fontSize"),10),l=o/i.width(),a=r*(l-.1);i.css("fontSize",e>0&&a>e?e:a)})}}(jQuery);